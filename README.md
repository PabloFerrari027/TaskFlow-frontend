...
NEXT_PUBLIC_GOOGLE_CLIENT_ID=   # opcional — login com Google fica oculto se vazio; também habilita "Confirmar com Google" na reautenticação de ações críticas do assistente
```
...
- `src/features` — auth, sessions, workspaces, projects, tasks, sections, custom-fields, comments, activity, analytics, assistant, admin, sync
