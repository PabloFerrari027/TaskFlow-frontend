...
// never needs a separate permission check on the frontend. Also backs the
// live preview of the dashboard-page chart builder (pass `workspaceId: null`
// to pause it while the query is still incomplete).
